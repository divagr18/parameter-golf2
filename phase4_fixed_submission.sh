...
export EVAL_BLEND_POSITION_BIAS="${EVAL_BLEND_POSITION_BIAS:-0.0}"
export EVAL_BLEND_POSITION_POWER="${EVAL_BLEND_POSITION_POWER:-1.0}"
export EVAL_CONT_CACHE_ENABLED="${EVAL_CONT_CACHE_ENABLED:-0}"
export EVAL_CONT_CACHE_WINDOW="${EVAL_CONT_CACHE_WINDOW:-8192}"
export EVAL_CONT_CACHE_TOPK="${EVAL_CONT_CACHE_TOPK:-64}"
export EVAL_CONT_CACHE_WEIGHT="${EVAL_CONT_CACHE_WEIGHT:-0.12}"
export EVAL_CONT_CACHE_LOGIT_SCALE="${EVAL_CONT_CACHE_LOGIT_SCALE:-12.0}"
export EVAL_CONT_CACHE_CONF_POWER="${EVAL_CONT_CACHE_CONF_POWER:-1.0}"
export EVAL_CONT_CACHE_BATCH_SEQS="${EVAL_CONT_CACHE_BATCH_SEQS:-8}"
...
echo "eval_blend:     ${EVAL_BLEND_SEQ_LENS} (rope_scales=${EVAL_BLEND_ROPE_SCALES} weights=${EVAL_BLEND_WEIGHTS} stride_frac=${EVAL_BLEND_STRIDE_FRAC} position_bias=${EVAL_BLEND_POSITION_BIAS} position_power=${EVAL_BLEND_POSITION_POWER})"
echo "eval_cont_cache:${EVAL_CONT_CACHE_ENABLED} (window=${EVAL_CONT_CACHE_WINDOW} topk=${EVAL_CONT_CACHE_TOPK} weight=${EVAL_CONT_CACHE_WEIGHT} logit_scale=${EVAL_CONT_CACHE_LOGIT_SCALE} conf_power=${EVAL_CONT_CACHE_CONF_POWER} batch_seqs=${EVAL_CONT_CACHE_BATCH_SEQS})"
