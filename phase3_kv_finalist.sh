...
echo "Finalist KV sweep config: iterations=${ITERATIONS} train_batch_tokens=${TRAIN_BATCH_TOKENS} grad_accum_steps=${GRAD_ACCUM_STEPS} val_max_tokens=${VAL_MAX_TOKENS} final_roundtrip_eval=${FINAL_ROUNDTRIP_EVAL}"
